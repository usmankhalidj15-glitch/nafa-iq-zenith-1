...
export const UR: Record<string, string> = {
  ...
  "Personalise how NafaIQ looks and feels.":
    "نفع آئی کیو کی شکل و صورت کو اپنی پسند کے مطابق بنائیں۔",
  ...
  "K-Electric bill due in 3 days — PKR 18,420": "کے-الیکٹرک بل 3 دن میں واجب — PKR 18,420",
  ...
  "Test Your Understanding — Take the Quiz": "اپنی سمجھ بوجھ آزمائیں — کوئز دیں",
  questions: "سوالات",
  ...
  "Perfect Score! Ustād level understanding!": "بہترین اسکور! استاد جیسی سمجھ بوجھ!",
  "Great work! One more review and you'll nail it.": "بہترین کام! ایک اور جائزہ اور آپ کامیاب!",
  "📖 Keep learning — review the lesson and retry.":
    "📖 سیکھتے رہیں — سبق کا جائزہ لیں اور دوبارہ کوشش کریں۔",
  "💪 Don't give up — re-read and try again!": "💪 ہمت نہ ہاریں — دوبارہ پڑھیں اور کوشش کریں!",
  ...
  "Foreign inflows lift PSX to fresh highs": "غیر ملکی سرمایہ PSX کو نئی بلندیوں پر لے گیا",
  "Analysts eye resistance near key levels": "ماہرین کلیدی سطحوں کے قریب مزاحمت پر نظر رکھے ہوئے",
  Positive: "مثبت",
  "2h ago": "2 گھنٹے پہلے",
  "5h ago": "5 گھنٹے پہلے",
  "1d ago": "1 دن پہلے",
