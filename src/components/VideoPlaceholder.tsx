...
export function VideoPlaceholder() {
  return (
    <div className="mx-auto mt-6 flex aspect-video w-full max-w-[640px] flex-col items-center justify-center gap-2.5 rounded-[12px] border border-dashed border-border bg-surface px-6 text-center">
